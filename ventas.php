...
echo $idActual;
$sql6 = "SELECT * FROM detalleventas WHERE idVenta='$idActual'"; 
$res6 = mysqli_query($conn, $sql6); 
while ($ventas = mysqli_fetch_assoc($res6)) { 
    $sql7="UPDATE detalleproducto SET cant=cant-'$ventas[cantidad]' WHERE producto='$ventas[producto]' AND 
    color='$ventas[color]' AND talle='$ventas[talle]'";
