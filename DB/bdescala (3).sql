...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2022 a las 01:54:21
...
(3, 'Remera Positive', 5290, 5, 'Remera de jersey manga corta y terminación al corte en color verde, con estampa grande en delantero “LIVING MY LIFE THROUGH POSITIVE VIBRATIONS” en color rosa y adornada con imágenes de flores, texto menor debajo y logo de la marca.', 2, '', '');
...
INSERT INTO `ventasproductos` (`idVentasProductos`, `codProducto`, `nombreProducto`, `nroVenta`, `talle`, `cantidad`, `color`, `precioTotal`, `nombreDeUsuario`) VALUES
(16, 1, '', NULL, 'S', 2, 'Lila', 9980, ''),
(19, 3, '', NULL, 'L', 1, 'verde agua', 5290, ''),
(21, 3, 'Remera Positive', NULL, 'L', 3, 'verde agua', 15870, 'ju123'),
(22, 1, 'Remera Stars', NULL, 'L', 1, 'Rosa', 4990, 'ju123'),
(24, 2, 'Remera Justina', NULL, 'S', 1, 'crudo', 4990, 'dana123');
...
--
ALTER TABLE `ventasproductos`
  MODIFY `idVentasProductos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
